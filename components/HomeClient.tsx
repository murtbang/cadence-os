...
export default function HomeClient() {
  ...
  const todoProps = { todos, categories, onToggle: handleToggleTodo, onReorder: handleReorderTodo, onAdd: handleAddTodo, onDelete: handleDeleteTodo, onEdit: handleEditTodo, onAddCategory: handleAddCategory, onRenameCategory: handleRenameCategory, onDeleteCategory: handleDeleteCategory };
